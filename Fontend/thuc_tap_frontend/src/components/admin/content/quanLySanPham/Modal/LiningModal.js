...
import { postCreatNewLining } from '../../../../../services/sanPham/LopLotService';
const LiningModal = (props) => {
    const { show, setShow,fetchListLining } = props;
    ...
    const handSubmitCreateLining = async () => {

        let res = await postCreatNewLining(ma, ten, trangThai)

        // thêm xong hiện thông báo và đóng modal 
        if (res.data) {
            toast.success('Thêm thành công')
            handleClose();
            await fetchListLining()
        }
        ...
        De giay
            ...
            >
                ...
                <Modal.Footer>
                    ...
                    <Button variant="primary" onClick={() => handSubmitCreateLining()}>
                        Save
                    </Button>
                </Modal.Footer>
            </Modal>
