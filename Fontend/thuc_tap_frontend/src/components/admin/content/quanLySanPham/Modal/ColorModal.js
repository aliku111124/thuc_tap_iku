...
import {postCreateNewColor} from '../../../../../services/sanPham/MauSacService';
const ColorModal = (props) => {
    const { show, setShow,fetchListColor } = props;
    ...
    const handSubmitCreateColor = async () => {

        let res = await postCreateNewColor(ma, ten, trangThai)

        // thêm xong hiện thông báo và đóng modal 
        if (res.data) {
            toast.success('Thêm thành công')
            handleClose();
            await fetchListColor()
        }
        ...
        De giay
            ...
            >
                ...
                <Modal.Footer>
                    ...
                    <Button variant="primary" onClick={() => handSubmitCreateColor()}>
                        Save
                    </Button>
                </Modal.Footer>
            </Modal>
